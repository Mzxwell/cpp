...
MemoryContext::~MemoryContext() {
  // your code
  for(MemoryContext*child:children_)delete child;
  for(auto it=allocations_.rbegin();it!=allocations_.rend();++it)std::cout<<"Chunk "<<*it<<" freed."<<std::endl;
}
